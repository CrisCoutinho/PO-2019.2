...
Original file is located at
    https://colab.research.google.com/drive/1gB_eShINlR6R9Go0bPXZ8OQEm9m6H05N
"""
...
for i in range(4):
    timeSort.append(timeit.timeit("insertionSort({})".format(listQuestion[i]),setup="from __main__ import geraLista,insertionSort, listInv",number = 1))
    listNumberSwap.append(insertionSort(listQuestion[i]))
    timeSortWorseCase.append(timeit.timeit("insertionSort({})".format(listQuestionWorseCase[i]),setup="from __main__ import geraLista,insertionSort, listInv",number = 1))
    listNumberSwapWorseCase.append(insertionSort(listQuestionWorseCase[i]))
